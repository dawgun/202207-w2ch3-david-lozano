const questions = [
    {
        ...
        content: [
            ...
            { answer: "arteria", question: "CON LA A. Conducto por donde va la sangre desde el corazón a las demás partes del cuerpo." }
        ]
    },
    {
        letter: "b",
        content: [
            ...
            { answer: "bilis", question: "CON LA B. Líquido amargo de color amarillo verdoso producido por el hígado y que ayuda a la digestión de los alimentos." }
        ]
    },
    {
        letter: "c",
        content: [
            ...
            { answer: "cereza", question: "CON LA C. Fruto del cerezo de color rojo oscuro." }
        ]
    },
    {
        letter: "d",
        content: [
            ...
            { answer: "dieresis", question: "CON LA D. Signo ortográfico que se coloca encima de la u para indicar que esta letra ha de pronunciarse." }
        ]
    },
    {
        letter: "e",
        content: [
            ...
            { answer: "estria", question: "CON LA E. Línea que se forma en la piel cuando ésta se ha estirado excesivamente." }
        ]
    },
    {
        letter: "f",
        content: [
            ...
            { answer: "fisiologia", question: "CON LA F. Ciencia que estudia las funciones de los órganos de los seres vivos." }
        ]
    },
    {
        letter: "g",
        content: [
            ...
            { answer: "guitarra", question: "CON LA G. Instrumento musical con seis cuerdas que hacemos sonar con los dedos." }
        ]
    },
    {
        letter: "h",
        content: [
            ...
            { answer: "hermano", question: "CON LA H. ¿Cómo se llama la persona que tiene el mismo padre y la misma madre que tú?" }
        ]
    },
    {
        letter: "i",
        content: [
            ...
            { answer: "invisible", question: "CON LA I. Añade un prefijo a la palabra visible para obtener lo contrario y tendrás…" }
        ]
    },
    {
        letter: "j",
        content: [
            ...
            { answer: "jabon", question: "CON LA J. Se utiliza para limpiar el cuerpo." }
        ]
    },
    {
        letter: "k",
    ...
    },
    {
        ...
        content: [
            ...
            { answer: "comba", question: "CONTIENE LA M. Juego que consiste en saltar por encima de una cuerda que se hace pasar por debajo de los pies y sobre la cabeza de quien salta." }
        ]
    },
    {
        letter: "n",
        content: [
            ...
            { answer: "naranja", question: "CON LA N. Del campo semántico de los colores y el color de una fruta con la que podemos hacer zumo." }
        ]
    },
    {
        letter: "ñ",
        content: [
            ...
            { answer: "niño", question: "CONTIENE LA Ñ. Persona que tiene pocos años." }
        ]
    },
    {
        letter: "o",
    ...
    },
    {
        ...
        content: [
            ...
            { answer: "panadero", question: "CON LA P. ¿Cómo se llama la persona que vende en una panadería?" }
        ]
    },
    {
        letter: "q",
        content: [
            ...
            { answer: "equilatero", question: "CONTIENE LA Q. Triángulo que tiene todos sus lados iguales." }
        ]
    },
    {
        letter: "r",
        content: [
            ...
            { answer: "rana", question: "CON LA R. El renacuajo es la cría de la... " }
        ]
    },
    {
        letter: "s",
        content: [
            ...
            { answer: "sosa", question: "CON LA S. Lo contrario de “La sopa está salada” es: “La sopa está...”" }
        ]
    },
    {
        letter: "t",
        content: [
            ...
            { answer: "tarta", question: "CON LA T. Pastel grande que no suele faltar en los cumpleaños." }
        ]
    },
    {
        letter: "u",
    ...
    },
    {
        ...
        content: [
            ...
            { answer: "vaso", question: "CON LA V. Recipiente que sirve para beber." }
        ]
    },
    {
        letter: "w",
        content: [
            ...
            { answer: "waterpolo", question: "CON LA W. Juego practicado en una piscina entre dos equipo, que consiste en introducir el balón en la portería contraria." }
        ]
    },
    {
        letter: "x",
        content: [
            ...
            { answer: "xilofono", question: "CONT LA X. Instrumento musical formado por láminas de diferentes tamaños, que suenan al golpearlas." }
        ]
    },
    {
        letter: "y",
    ...
    },
    {
        ...
        content: [
            ...
            { answer: "zapato", question: "CON LA Z. Calzado que nos ponemos en los pies para caminar." }
        ]
    }
]
...
function juegoPasapalabra() {
    ...
    while (volveraComenzar) {
        ...
        let nombreUsuario = registroUsuario();
        let preguntasFinales = ListaPreguntasPasapalabra();
        let respuestasAcertadas = preguntasRespuestas(preguntasFinales);
...
function bienvenidaPasapalabra() {
    ...
    alert('Bienvenido al Pasapalabra de David, donde podrás ganar grandes sumas de dinero');
    alert('El juego trata de responder correctamente 27 palabras que cada una contendrá una palabra del abecedario.');
    alert('Al final del juego entrarás en el ranking donde verás los 10 mejores participantes según las palabras acertadas');
}
...
function ListaPreguntasPasapalabra() {
    ...
    for(i = 0; i < abecedario.length; i++) {
        ...
        let preguntaRandom = Math.floor(Math.random() * numeroPreguntas);
        let letter = abecedario[i];
        let content = questions.find(question=> question.letter === abecedario[i]).content[preguntaRandom];
...
function preguntasRespuestas(preguntasFinales) {
    ...
    let opcionesPasapalabra = '\n\nPasapalabra: Respondes más tarde\nEnd: Terminas la partida actual';
    let respuestasAcertadas = 0;
    let respuestasFalladas = 0;
    let respuestaPasapalabra;
    const ajustesPalabra = (str) => {return str.normalize("NFD").replace(/([^n\u0300-\u036f]|n(?!\u0303(?![\u0300-\u036f])))[\u0300-\u036f]+/gi,"$1").toLowerCase().trim();}
    
    while(preguntasFinales.findIndex(obj => obj.status === 0) != -1) {
    
        for (i = 0; i < preguntasFinales.length; i++) {
            if (preguntasFinales[i].status === 0) {      
                do { 
                    respuestaPasapalabra = prompt(preguntasFinales[i].question + opcionesPasapalabra);
                    if (respuestaPasapalabra === null|| respuestaPasapalabra.length === 0) {
                        alert('Por favor, debes responder algo');
                    }
                } while(respuestaPasapalabra === null || respuestaPasapalabra.length === 0);
                ...
                switch(ajustesPalabra(respuestaPasapalabra)) {
                    ...
                    case 'pasapalabra':
                        ...
                        break;
                    case 'end':
                        alert('Has acertado un total de ' + respuestasAcertadas + ' palabras, pero como no has terminado el juego, no entrarás en el ranking');
                        return false;
                    default:
                        alert('¡Respuesta incorrecta! La respuesta correcta era ' + preguntasFinales[i].answer);
                        preguntasFinales[i].status = -1;
                        respuestasFalladas++;
                }
            }
    ...
    alert('Has acertado un total de ' + respuestasAcertadas + ' palabras, y has fallado un total de ' + respuestasFalladas + '.' );
...
function rankingPasapalabra (nombreUsuario, respuestasAcertadas) { 
    ...
    ranking.push({posicion: "X", nombre:nombreUsuario, aciertos:(respuestasAcertadas)});
...
function repetirPasapalabra() {
    ...
    let nuevaPartidaPasapalabra = prompt("¿Quieres comenzar una nueva partida? ('Yes' para comenzar de nuevo)");
    if (nuevaPartidaPasapalabra != null && nuevaPartidaPasapalabra.toLowerCase() === 'yes') {
        return true;
    } else {
        return false;
    } 
