...
const resolverCalculo = (simboloEspecial, numeroEspecial) => {
...
const pulsarNumero = (numeroPulsado) => {
  if (
    primerNumero === "" ||
    simboloIgual === "=" ||
    (primerNumero == "0" && !simbolo)
  ) {
    simboloIgual = "A";
  ...
  if (
    simbolo &&
    (segundoNumero == "0" || simboloIgual === "B" || segundoNumero == "")
  ) {
...
const funcionesBasicas = (simboloPulsado) => {
...
const funcionesEspeciales = (simboloEspecial) => {
...
const calculadoraMaestra = (boton) => {
