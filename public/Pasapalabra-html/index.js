  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        answer: "cereza",
        letra: "EMPIEZA POR C.",
        question: "Fruto del cerezo de color rojo oscuro.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        letra: "EMPIEZA POR G.",
        question:
          "Instrumento musical con seis cuerdas que hacemos sonar con los dedos.",
      },
    ],
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        letra: "EMPIEZA POR H.",
        question:
          "¿Cómo se llama la persona que tiene el mismo padre y la misma madre que tú?",
      },
    ],
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        letra: "EMPIEZA POR I.",
        question:
          "Añade un prefijo a la palabra visible para obtener lo contrario y tendrás…",
      },
    ],
  },
  {
    ...
    content: [
      ...
      },
      {
        answer: "jabon",
        letra: "EMPIEZA POR J.",
        question: "Se utiliza para limpiar el cuerpo.",
      },
    ],
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        letra: "EMPIEZA POR K.",
        question:
          "Animal parecido a un oso pequeño y que podemos encontrar en Australia.",
      },
    ],
  },
  {
    ...
    content: [
      ...
      },
      {
        answer: "libreria",
        letra: "EMPIEZA POR L.",
        question: "Lugar en el que se compran libros.",
      },
    ],
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        letra: "CONTIENE LA M.",
        question:
          "Juego que consiste en saltar por encima de una cuerda que se hace pasar por debajo de los pies y sobre la cabeza de quien salta.",
      },
    ],
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        letra: "EMPIEZA POR N.",
        question:
          "Del campo semántico de los colores y el color de una fruta con la que podemos hacer zumo.",
      },
    ],
  },
  {
    ...
    content: [
      ...
      },
      {
        answer: "niño",
        letra: "CONTIENE LA Ñ.",
        question: "Persona que tiene pocos años.",
      },
    ],
  },
  {
    ...
    content: [
      ...
      },
      {
        answer: "oscuro",
        letra: "EMPIEZA POR O.",
        question: "El antónimo de claro es...",
      },
    ],
  },
  {
    ...
    content: [
      ...
      },
      {
        answer: "panadero",
        letra: "EMPIEZA POR P.",
        question: "¿Cómo se llama la persona que vende en una panadería?",
      },
    ],
  },
  {
    ...
    content: [
      ...
      },
      {
        answer: "equilatero",
        letra: "CONTIENE LA Q.",
        question: "Triángulo que tiene todos sus lados iguales.",
      },
    ],
  },
  {
    ...
    content: [
      { answer: "raton", letra: "EMPIEZA POR R.", question: "Roedor." },
      {
        answer: "rana",
        letra: "EMPIEZA POR R.",
        question: "El renacuajo es la cría de la... ",
      },
    ],
  },
  {
    ...
    content: [
      ...
      },
      {
        answer: "sosa",
        letra: "EMPIEZA POR S.",
        question: "Lo contrario de “La sopa está salada” es: “La sopa está...”",
      },
    ],
  },
  {
    ...
    content: [
      ...
      },
      {
        answer: "tarta",
        letra: "EMPIEZA POR T.",
        question: "Pastel grande que no suele faltar en los cumpleaños.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        answer: "vaso",
        letra: "EMPIEZA POR V.",
        question: "Recipiente que sirve para beber.",
      },
    ],
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        letra: "EMPIEZA POR W.",
        question:
          "Juego practicado en una piscina entre dos equipo, que consiste en introducir el balón en la portería contraria.",
      },
    ],
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        letra: "EMPIEZA POR X.",
        question:
          "Instrumento musical formado por láminas de diferentes tamaños, que suenan al golpearlas.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        answer: "zapato",
        letra: "EMPIEZA POR Z.",
        question: "Calzado que nos ponemos en los pies para caminar.",
      },
    ],
  },
];
...
const questionListPasapalabra = () => {
  ...
  for (let i = 0; i < alphabet.length; i++) {
    ...
    const preguntaRandom = Math.floor(Math.random() * questionNumber);
    const content = questions.find(
      (question) => question.letter === alphabet[i]
...
const finalGame = () => {
  ...
  document.getElementById("paciertosfinal").innerHTML =
    document.getElementById("aciertos").innerHTML;
  document.getElementById("pfallosfinal").innerHTML =
    document.getElementById("falladas").innerHTML;
  document.getElementById("ptiemporestante").innerHTML =
...
const countDown = () => {
  downloadTimer = setInterval(() => {
    const timeleft = document.getElementById("tiempo").innerHTML;
...
const nextQuestion = () => {
  ...
  document.getElementById("letraseleccionada").innerHTML =
    finalQuestions[0].letra;
...
const answerFailed = () => {
  ...
  document.getElementById("letrafallada").innerHTML =
    finalQuestions[0].letter.toUpperCase();
  document.getElementById("respuestacorrecta").innerHTML =
    finalQuestions[0].answer.toUpperCase();
  document.getElementById("preguntasyrespuestas").style.display = "none";
...
const wordAnswered = () => {
  ...
  letterList.forEach((letraid) => {
    if (finalQuestions[0].letter === letraid.id) {
      if (
        finalQuestions[0].answer ===
        wordFix(document.getElementById("palabraRespondida").value)
      ) {
